"""
The 64 character challenge of 150, 000 USD
The file given is a bunch of ~430,000 strings that you will use as the training and test set


After training there is an evaluation string that lets you deremine whether what you did is what is actually right

Objective: Generate a 64 character alphanumeric string that the evaluation function says is valid,
is not contained in the test data set of known strings and has an ID of above 4,700,000


Bottom Line : Assignment is to create a model that generates a 64 chracter string
